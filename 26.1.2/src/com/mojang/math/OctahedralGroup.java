...
public enum OctahedralGroup implements StringRepresentable {
      ...
      () -> {
         ...
         for (OctahedralGroup first : values) {
            for (OctahedralGroup second : values) {
               ...
               boolean composedInvertX = first.inverts(net.minecraft.core.Direction.Axis.X)
                  ^ second.inverts(first.permutation.permuteAxis(net.minecraft.core.Direction.Axis.X));
               boolean composedInvertY = first.inverts(net.minecraft.core.Direction.Axis.Y)
                  ^ second.inverts(first.permutation.permuteAxis(net.minecraft.core.Direction.Axis.Y));
               boolean composedInvertZ = first.inverts(net.minecraft.core.Direction.Axis.Z)
                  ^ second.inverts(first.permutation.permuteAxis(net.minecraft.core.Direction.Axis.Z));
   ...
   public Direction rotate(final Direction direction) {
      if (this.rotatedDirections == null) {
         this.rotatedDirections = Util.makeEnumMap(Direction.class, facing -> {
            net.minecraft.core.Direction.Axis oldAxis = facing.getAxis();
            AxisDirection oldDirection = facing.getAxisDirection();
            net.minecraft.core.Direction.Axis newAxis = this.permutation.inverse().permuteAxis(oldAxis);
            AxisDirection newDirection = this.inverts(newAxis) ? oldDirection.opposite() : oldDirection;
   ...
   public boolean inverts(final net.minecraft.core.Direction.Axis axis) {
      return switch (axis) {
         case X -> this.invertX;
         case Y -> this.invertY;
         case Z -> this.invertZ;
