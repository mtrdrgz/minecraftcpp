...
public class RealmsWorldSlotButton extends Button {
   ...
   public RealmsWorldSlotButton(
      final int x, final int y, final int width, final int height, final int slotIndex, final RealmsServer serverData, final OnPress onPress
   ) {
   ...
   public void extractContents(final GuiGraphicsExtractor graphics, final int mouseX, final int mouseY, final float a) {
      ...
      this.slotNameWidget.setMaxWidth(this.getWidth() - (this.state.activeSlot ? 2 : 0), TextOverflow.SCROLLING);
