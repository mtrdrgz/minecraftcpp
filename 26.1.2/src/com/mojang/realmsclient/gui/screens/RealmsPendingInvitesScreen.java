...
public class RealmsPendingInvitesScreen extends RealmsScreen {
   ...
   private class Entry extends net.minecraft.client.gui.components.ContainerObjectSelectionList.Entry<RealmsPendingInvitesScreen.Entry> {
      ...
      Entry(final PendingInvite pendingInvite) {
         ...
         this.inviteDate = new StringWidget(
            ...
            .setMaxWidth(maxTextWidth);
         CreateNarration narration = this.getCreateNarration(pendingInvite);
      ...
      private CreateNarration getCreateNarration(final PendingInvite pendingInvite) {
