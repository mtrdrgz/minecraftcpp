...
public class RealmsSettingsTab extends GridLayoutTab implements RealmsConfigurationTab {
   ...
   RealmsSettingsTab(
      ...
      RowHelper helper = this.layout.rowSpacing(6).createRowHelper(1);
      ...
      EqualSpacingLayout selectedRegion = new EqualSpacingLayout(0, 0, 212, 9, Orientation.HORIZONTAL);
      ...
      helper.addChild(SpacerElement.height(2));
      this.closeOpenButton = (Button)helper.addChild(
         Button.builder(
               Component.empty(),
               button -> {
