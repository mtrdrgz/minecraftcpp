...
public class RenderPipelines {
   ...
   private static final Snippet BEACON_BEAM_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_FOG_SNIPPET})
      ...
      .withDepthStencilState(DepthStencilState.DEFAULT)
      .buildSnippet();
   private static final Snippet ITEM_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_FOG_LIGHT_DIR_SNIPPET})
   ...
   private static final Snippet GUI_TEXTURED_SNIPPET = RenderPipeline.builder(new Snippet[]{MATRICES_PROJECTION_SNIPPET})
      ...
      .buildSnippet();
   private static final Snippet GUI_TEXT_SNIPPET = RenderPipeline.builder(new Snippet[]{TEXT_SNIPPET}).withDepthStencilState(Optional.empty()).buildSnippet();
   ...
   public static final RenderPipeline ITEM_CUTOUT = register(
      RenderPipeline.builder(new Snippet[]{ITEM_SNIPPET}).withLocation("pipeline/item_cutout").withShaderDefine("ALPHA_CUTOUT", 0.1F).build()
   );
   public static final RenderPipeline ITEM_TRANSLUCENT = register(
      RenderPipeline.builder(new Snippet[]{ITEM_SNIPPET})
   ...
   public static final RenderPipeline TRANSLUCENT_PARTICLE = register(
      RenderPipeline.builder(new Snippet[]{PARTICLE_SNIPPET})
   ...
   public static final RenderPipeline WEATHER_NO_DEPTH_WRITE = register(
      RenderPipeline.builder(new Snippet[]{WEATHER_SNIPPET})
   ...
   public static final RenderPipeline GUI_INVERT = register(
      RenderPipeline.builder(new Snippet[]{GUI_SNIPPET})
   ...
   public static final RenderPipeline BLOCK_SCREEN_EFFECT = register(
      RenderPipeline.builder(new Snippet[]{GUI_TEXTURED_SNIPPET}).withLocation("pipeline/block_screen_effect").build()
   );
   public static final RenderPipeline FIRE_SCREEN_EFFECT = register(
      RenderPipeline.builder(new Snippet[]{GUI_TEXTURED_SNIPPET}).withLocation("pipeline/fire_screen_effect").build()
   );
