...
public class SurfaceRuleData {
   ...
   public static SurfaceRules.RuleSource overworldLike(final boolean doPreliminarySurfaceCheck, final boolean bedrockRoof, final boolean bedrockFloor) {
      ...
      SurfaceRules.RuleSource biomeSurfaceRule = SurfaceRules.sequence(
         ...
         SurfaceRules.ifTrue(
            SurfaceRules.isBiome(Biomes.JAGGED_PEAKS), SurfaceRules.sequence(SurfaceRules.ifTrue(steep, STONE), SurfaceRules.ifTrue(aboveWater, SNOW_BLOCK))
         ),
         ...
         SurfaceRules.ifTrue(
            ...
            SurfaceRules.sequence(
               ...
               SurfaceRules.ifTrue(
                  ...
                  SurfaceRules.ifTrue(
                     swampPuddleLevel,
                     SurfaceRules.ifTrue(SurfaceRules.not(aboveOverworldSeaLevel), SurfaceRules.ifTrue(SurfaceRules.noiseCondition(Noises.SWAMP, 0.0), WATER))
                  )
               ),
               SurfaceRules.ifTrue(
