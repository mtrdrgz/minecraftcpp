// Ground truth for net.minecraft.network.protocol.game.ServerboundContainerClosePacket.
//
...
// (ServerboundContainerClosePacket lines 9-24). FriendlyByteBuf.writeContainerId /
...
// equality as a sanity check before emitting. The C++ pkt_container_close_sb_parity
...
public class PktContainerCloseSbParity {
    ...
    public static void main(String[] args) throws Exception {
        ...
        StreamCodec<FriendlyByteBuf, ServerboundContainerClosePacket> CODEC =
            (StreamCodec<FriendlyByteBuf, ServerboundContainerClosePacket>)
                ServerboundContainerClosePacket.STREAM_CODEC;
        ...
        for (int containerId : containerIds) {
            ...
            ServerboundContainerClosePacket pkt = new ServerboundContainerClosePacket(containerId);
            ...
            ServerboundContainerClosePacket dec = CODEC.decode(rbuf);
