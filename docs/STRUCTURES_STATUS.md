...
>
> Last updated: 2026-06-21 (session: structures audit + honesty pass).
...
| nether_fossils | nether_fossil | **Placed (approx.)** | ⚠ Y hardcoded to 32 (`StructureGen.cpp:1433`) instead of the noise-column scan — a RULE #0 approximation to remove. Nether-only; should also be dimension-gated. |
