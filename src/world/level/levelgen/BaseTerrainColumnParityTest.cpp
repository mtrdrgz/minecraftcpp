// Parity test for base overworld terrain columns before surface/carvers/decoration.
//
// Ground truth: tools/BaseTerrainColumnParity.java, which calls the real Java
// NoiseBasedChunkGenerator.getBaseColumn().
//   mcpp/tools/run_groundtruth.ps1 -Tool BaseTerrainColumnParity -Out build/base_terrain_columns.tsv
//   base_terrain_column_parity --cases build/base_terrain_columns.tsv
...
int main(int argc, char** argv) {
    ...
    if (casesPath.empty()) {
        std::cerr << "usage: base_terrain_column_parity --cases <tsv>\n";
        return 2;
    }
    ...
    std::cout << "BaseTerrainColumn cases=" << total << " mismatches=" << mismatches << "\n";
