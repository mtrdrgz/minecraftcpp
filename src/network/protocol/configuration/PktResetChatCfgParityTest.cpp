// ClientboundResetChatPacket codec parity vs the REAL net.minecraft StreamCodec
// (tools/PktResetChatCfgParity.java ground truth).
//
// ClientboundResetChatPacket.STREAM_CODEC == StreamCodec.unit(INSTANCE): a unit
...
//
// TSV rows:  RESET_CHAT_CFG <name> <readableBytes> <hexBytes(empty)> <isInstance>
//
//   pkt_reset_chat_cfg_parity [--cases mcpp/build/pkt_reset_chat_cfg.tsv]
...
int main(int argc, char** argv) {
    ...
    while (std::getline(f, line)) {
        ...
        if (tag != "RESET_CHAT_CFG") continue;
    ...
    std::cout << "PktResetChatCfgParity cases=" << cases << " mismatches=" << mismatches << "\n";
