...
//
// Real codec order (ServerboundSelectKnownPacks.STREAM_CODEC, 26.1.2):
//   record(List<KnownPack> knownPacks)
//   StreamCodec.composite( KnownPack.STREAM_CODEC.apply(ByteBufCodecs.list(64)), ... )
//
// ByteBufCodecs.list(64) == collection(ArrayList::new, KnownPack.STREAM_CODEC, 64)
// (ByteBufCodecs.java:413-435):
...
//
//   pkt_select_known_packs_sb_parity --cases mcpp/build/pkt_select_known_packs_sb.tsv
...
int main(int argc, char** argv) {
    ...
    std::printf("PktSelectKnownPacksSbParity cases=%d mismatches=%d\n", cases, mismatches);
