// Parity gate for ItemStack.OPTIONAL_STREAM_CODEC over the NO-COMPONENT domain (the bulk of
// inventory packets: SetSlot/SetContent/SetCursorItem/SetEquipment/SetPlayerInventory).
// Wire form (ItemStack.java:185-193, DataComponentPatch.java:106-109):
...
//   itemstack_stream_parity --cases mcpp/build/itemstack_stream.tsv [--asset <path>]
//
...
int main(int argc, char** argv) {
    ...
    std::cout << "ItemStackStream cases=" << cases << " mismatches=" << mism << "\n";
    return mism == 0 ? 0 : 1;
}
