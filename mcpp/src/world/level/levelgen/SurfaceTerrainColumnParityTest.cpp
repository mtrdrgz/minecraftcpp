// Parity test for overworld terrain columns after buildSurface and before
// carvers/structures/features/decoration.
...
int main(int argc, char** argv) {
    ...
    if (casesPath.empty()) {
        std::cerr << "usage: surface_terrain_column_parity --cases <tsv>\n";
        return 2;
    }
    ...
    std::cout << "SurfaceTerrainColumn cases=" << total << " mismatches=" << mismatches << "\n";
