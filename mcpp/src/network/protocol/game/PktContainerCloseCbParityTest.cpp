// Parity gate for ClientboundContainerClosePacket's StreamCodec vs the REAL
// net.minecraft codec (tools/PktContainerCloseCbParity.java ground truth).
//
...
// (net.minecraft.network.protocol.game.ClientboundContainerClosePacket lines 9-24).
...
//
//   pkt_container_close_cb_parity [--cases mcpp/build/pkt_container_close_cb.tsv]
...
int main(int argc, char** argv) {
    std::string casesPath = "mcpp/build/pkt_container_close_cb.tsv";
    ...
    std::cout << "PktContainerCloseCbParity cases=" << cases
